...
export default function Dashboard({orders,onOpen,onNew}:{orders:WorkOrder[];onOpen:(id:number)=>void;onNew:()=>void}){
 ...
 const months=Array.from({length:currentMonth+1},(_,i)=>orders.filter(o=>{if(!o.openedAt)return false;const d=new Date(o.openedAt+'T12:00:00');return Number.isFinite(d.getTime())&&d.getFullYear()===currentYear&&d.getMonth()===i}).length);
