...
import { LayoutDashboard, ClipboardPlus, FileText, Database, BarChart3, Settings, Archive, LogOut, Users } from 'lucide-react';
...
export default function App(){
 ...
 return <div className="app-shell"><aside className="sidebar"><div className="brand"><div className="brand-mark">SOS</div><div><strong>S.O.S</strong><span>{session.name} • {session.role}</span></div></div><nav>
